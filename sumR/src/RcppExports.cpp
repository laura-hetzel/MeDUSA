...
RcppExport SEXP _sumR_getLocalMaximaC(SEXP intensitiesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type intensities(intensitiesSEXP);
    rcpp_result_gen = Rcpp::wrap(getLocalMaximaC(intensities));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_sumR_getLocalMaximaC", (DL_FUNC) &_sumR_getLocalMaximaC, 1},
    {NULL, NULL, 0}
};
